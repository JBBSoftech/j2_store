...
class ApiConfig {
  ...
  static String get appId {
    ...
    if (raw == 'APP_ID_HERE' || raw.isEmpty) {
...
class SessionManager {
  ...
  static String get adminUserId => ApiConfig.adminObjectId;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ...
          SnackBar(
            ...
            content: Text(() {
              if (e is num) {
                return 'Failed: Unable to connect to server. Please check API_BASE (http://172.20.10.5:5000)';
              }
