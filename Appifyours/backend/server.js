...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/j2_store__app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6971ded9fb8141714bc58524',
      shopName: 'j2 store ',
...
app.listen(PORT, () => {
  console.log(`j2 store  Backend Server running on port ${PORT}`);
});
